<div>
    <div>
        ...
        <head>
            ...
            <title>Kết quả thi thử 15 Câu trắc nghiệm Este có đáp án - vietjack.online</title>
            ...
            <meta property="og:title" content="Kết quả thi thử 15 Câu trắc nghiệm Este có đáp án" />
                    ...
                    <div class="container">
                        <div class="headline bg0 flex-wr-sb-c m-tb-10">
                            <div class="f2-s-1 p-r-30 m-tb-6">
                                ...
                                <a href="https://vietjack.online/kiem-tra-thi-thu/15-cau-trac-nghiem-este-co-dap-an/28287" class="breadcrumb-item f1-s-3 active">
                                            ...
                                            <div class="col-md-5">
                                                <div class="jumbotron text-center">
                                                    ...
                                                    <p style="height: 70px; font-size: 70px;">
                                                        {{ $totalScore }}/{{ $quizAttempt->quiz->questions->count() }}
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="col-md-7">
                                                <div>
                                                    ...
                                                    <ul class="exam-infor">
                                                        ...
                                                        <li>
                                                            <p><i class="far fa-calendar-check"></i> {{ $quizAttemptsCount }} lượt thi</p>
                                                        </li>
                                                        <!-- Hiển thị số câu hỏi -->
                                                        <li>
                                                            <p><i class="far fa-question-circle"></i> {{ $quizAttempt->quiz->questions->count() }} câu hỏi</p>
                                                        </li>
                                                        <!-- Hiển thị thời gian làm bài -->
                                                        <li>
                                                            <p><i class="far fa-clock"></i> {{ $quizAttempt->quiz->duration }} phút</p>
                                                        </li>
                                                    </ul>
                                                    ...
                                                    <div class="row m-t-10">
                                                        <div class="col-md-6">
                                                            ...
                                                            <a href="{{ route('quiz.take', $quizAttempt->quiz->id) }}" class="btn-action">
                                                ...
                                                <div class="test-result-detail">
                                                    ...
                                                    <div class="quiz-answer-item" id="question_{{ $question['id'] }}">
                                                        <div class="question-header">
                                                            <p class="number-question">Câu {{ $index + 1 }}:
                                                                <span class="">
                                                        ...
                                                        <!-- Kiểm tra type của câu hỏi -->
                                                        @if($question['type'] == 'value')
                                                            <!-- Chỉ render đáp án đúng mà không cần các lựa chọn A, B, C, D -->
                                                            <div class="col-12">

                                                                <div class="question-correct-answer">
                                                                    {{-- @if ($question['type'] === 'value')
                                                                    <!-- Nếu câu hỏi là loại value, hiển thị text của option đầu tiên -->
                                                                    <p class="MsoNormal"><strong>Đáp án đúng: {{ $question['options']->first()["text"] }}</strong></p>
                                                                @else
                                                                <h3 class="f1-s-10 cl3 p-tb-12 text-uppercase" style="color: #ff9700;">
                                                                    Đáp án đúng
                                                                </h3>
                                                                    <!-- Nếu không phải là loại value, hiển thị đáp án đúng như bình thường -->
                                                                    <p class="MsoNormal"><strong>Đáp án đúng: {{ $question['correct_answer'] }}</strong></p>
                                                                @endif --}}
                                                                </div>
                                                            </div>
                                                        @else
                                                            <!-- Với các câu hỏi có nhiều lựa chọn, render các lựa chọn A, B, C, D -->
                                                            <div class="question-answer-list row">
                                                                @foreach($question['options'] as $optionIndex => $option)
                                                                    <div class="answer-item col-12 d-flex {{ $option['is_correct'] ? 'correct' : '' }} {{ $option['text'] == $question['selected_option'] ? 'selected' : '' }}">
                                                                        <p>
                                                                            <strong>{{ chr(65 + $optionIndex) }}.</strong> {{ $option['text'] }}
                                                                        </p>
                                                                    </div>
                                                                @endforeach
                                                            </div>
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <div class="question-reason">
                                                                ...
                                                                <h3 class="f1-s-10 cl3 p-tb-12 text-uppercase" style="color: #ff9700;">
                                                                    ...
                                                                    <p class="MsoNormal"><strong>Đáp án đúng: {{ $question['correct_answer'] }}</strong></p>
                                                                @endif
                                                                <!-- Add explanation or images here if needed -->
                                                            </div>
